...
var actionMap = {
  ...
  tabForward: function () {
    extensionCommunicator.requestTabForward();
  },

  tabBack: function () {
    extensionCommunicator.requestTabBackward();
  },

  scrollDown: function () {
    customScrollBy(0, settings.scrollSize);
  },
  ...
  scrollLeft: function () {
    customScrollBy(-settings.scrollSize, 0);
  },
  ...
  openTab: function () {
    window.open(settings.openTabUrl);
  },

  closeTab: function () {
    extensionCommunicator.requestCloseTab();
  },

  scrollDownHalfPage: function () {
    customScrollBy(0, window.innerHeight / 2);
  },
  ...
  goToPageBottom: function () {
    customScrollBy(0, document.body.scrollHeight);
  },
...
function goToFirstInput() {
  ...
  inputs.forEach(function (input) {
    ...
    var isInView =
      inputRect.top >= -inputRect.height &&
